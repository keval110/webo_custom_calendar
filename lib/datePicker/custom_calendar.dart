...
class CustomCalendarState extends State<CustomCalendar> {
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              '${date.day}',
                              style: TextStyle(
                                  color:getInMaxMinRange(date)? Colors.grey.withOpacity(0.6):getIsItStartAndEndDate(date)
                                      ? Colors.white
  ...
  bool getInMaxMinRange(DateTime date) {
    if (widget.minimumDate != null && widget.maximumDate != null) {
      if (date.isAfter(widget.maximumDate!) || date.isBefore(widget.minimumDate!)) {
        return true;
      } else {
        return false;
      }
